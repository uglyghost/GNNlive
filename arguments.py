...
parser.add_argument('--sampleRate', default=8, type=int, help='how many frame of each')
...
# cluster
parser.add_argument('--threshold', default=160, type=int, help='threshold of viewing similarity')
