...
parser.add_argument('--epochGCN', default=100, type=float, help='the epoch for GCN')
...
parser.add_argument('--trainNum', default=20, type=int, help='number of user for training')
